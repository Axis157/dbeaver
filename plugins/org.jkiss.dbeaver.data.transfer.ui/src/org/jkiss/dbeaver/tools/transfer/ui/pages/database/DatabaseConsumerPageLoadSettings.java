...
public class DatabaseConsumerPageLoadSettings extends ActiveWizardPage<DataTransferWizard> {
    ...
    public DatabaseConsumerPageLoadSettings() {
        super(DTUIMessages.data_transfer_wizard_page_consumer_load_settings_name);
        setTitle(DTUIMessages.data_transfer_wizard_page_consumer_load_settings_title);
        setDescription(DTUIMessages.data_transfer_wizard_page_consumer_load_settings_description);
    }
    ...
    public void createControl(Composite parent) {
...

        {
            Group loadSettings = UIUtils.createControlGroup(composite,
            		DTUIMessages.data_transfer_wizard_page_consumer_load_settings_name,
            		1,
            ...
            transferAutoGeneratedColumns = UIUtils.createCheckbox(
                loadSettings,
                DTUIMessages.data_transfer_wizard_page_consumer_load_settings_group_load_settings_label,
                DTUIMessages.data_transfer_wizard_page_consumer_load_settings_group_load_settings_tooltip,
            ...
            truncateTargetTable = UIUtils.createCheckbox(loadSettings,
            		DTUIMessages.data_transfer_wizard_page_consumer_load_settings_group_load_settings_checkbox,
...

        {
            Group performanceSettings = UIUtils.createControlGroup(composite,
            		DTUIMessages.data_transfer_wizard_page_consumer_load_settings_group_performance_settings,
            		4,
            		GridData.FILL_HORIZONTAL,
            		0);
            ...
            final Button useTransactionsCheck = UIUtils.createCheckbox(performanceSettings,
            		DTUIMessages.data_transfer_wizard_page_consumer_load_settings_checkbox_use_transactions,
            		null,
            ...
            final Spinner commitAfterEdit = UIUtils.createLabelSpinner(performanceSettings,
            		DTUIMessages.data_transfer_wizard_page_consumer_load_settings_label_spinner_commit,
...

        {
            Group generalSettings = UIUtils.createControlGroup(composite,
            		DTUIMessages.data_transfer_wizard_page_consumer_load_settings_group_general,
            		4,
            		GridData.FILL_HORIZONTAL,
            		0);
            final Button showTableCheckbox = UIUtils.createCheckbox(generalSettings,
            		DTUIMessages.data_transfer_wizard_page_consumer_load_settings_checkbox_show_table,
            		null,
            ...
            final Button showFinalMessageCheckbox = UIUtils.createCheckbox(generalSettings,
            		DTUIMessages.data_transfer_wizard_page_consumer_load_settings_checkbox_show_final_message,
            		null,
    ...
    private boolean confirmDataTruncate() {
        ...
        if (shell.isVisible() || getSettings().isTruncateBeforeLoad()) {
            ...
            if (!UIUtils.confirmAction(shell, DTUIMessages.data_transfer_wizard_page_consumer_load_settings_confirm_title,
            	DTUIMessages.data_transfer_wizard_page_consumer_load_settings_confirm_question + "(" + tableNames + ").\n" +
                DTUIMessages.data_transfer_wizard_page_consumer_load_settings_confirm_question_final))
            {
                return false;
            }
        }
